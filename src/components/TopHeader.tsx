...
export default function TopHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-zinc-200/60 bg-white/80 px-6 py-3.5 backdrop-blur-md dark:border-zinc-800/60 dark:bg-zinc-950/80">
      {/* Left Greeting */}
      <div>
      ...
      <div className="flex items-center gap-3">
        {/* Current Date Pill */}
        {formattedDate && (
          <div className="hidden lg:flex items-center gap-2 rounded-2xl border border-zinc-200/80 bg-zinc-50/80 px-3.5 py-1.5 text-xs font-semibold text-zinc-600 shadow-2xs dark:border-zinc-800 dark:bg-zinc-900/80 dark:text-zinc-400">
            <span>📅</span>
        ...
        <div className="flex items-center gap-1 rounded-2xl border border-zinc-200/80 bg-zinc-50/80 p-1 dark:border-zinc-800 dark:bg-zinc-900/80">
          <button
            title="Bildirimler"
